...
export default function Sidebar({
    ...
    const drawerContent = (
        ...
        >
            ...
            {/*
             * Cross-site nav (Home / Demo / Widget / amispoof) intentionally
             * lives ONLY in the shared <fivucsas-launcher> FAB (public/launcher.js,
             * loaded in index.html) — the single app-switcher across all FIVUCSAS
             * sites. The bespoke "FIVUCSAS suite" sidebar bar that used to be here
             * was removed 2026-05-29 as a leftover duplicate (the 2026-05-28
             * launcher rollout deleted the equivalent bars on every other site).
             */}
