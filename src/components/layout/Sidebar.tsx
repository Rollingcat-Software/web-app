...
const menuItems: MenuItem[] = [
    ...
    {labelKey: 'nav.cardDetection', icon: <CreditCard/>, path: '/card-detection'},
    {labelKey: 'nav.faceSearch', icon: <Face/>, path: '/face-search'},
    {labelKey: 'nav.voiceSearch', icon: <RecordVoiceOver/>, path: '/voice-search'},
