import {EnrollmentJob, EnrollmentStatus, PaginatedResponse} from '../types'
// import api from './api' // TODO: Uncomment when backend ready

// Mock mode - controlled by environment variable (default to true for development)
const MOCK_MODE = import.meta.env.VITE_ENABLE_MOCK_API !== 'false'
