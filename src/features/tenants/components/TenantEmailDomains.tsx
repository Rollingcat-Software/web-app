...
import { Add, DeleteOutline, Language, StarOutline, Star } from '@mui/icons-material'
import { useService } from '@app/providers'
import { TYPES } from '@core/di/types'
import type { ITenantRepository, TenantEmailDomain } from '@domain/interfaces/ITenantRepository'
